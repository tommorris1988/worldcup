...
<div class="social bar <?php if($content = $post->post_content ){} else { echo 'fixed'; }?>">
	<ul>
		<li>Share:</li>
		<li><a class="icon icon-twitter" rel="nofollow" href="http://twitter.com/home?status=<?php echo the_permalink(); echo urlencode(" #itskickingoff");?>&text=<?php the_title(); ?>" title="Tweet This" target="_blank">Twitter</a></li>
